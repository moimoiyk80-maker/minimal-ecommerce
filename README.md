...
사용자가 상태 변화와 행동 결과를 명확하게 이해할 수 있는지를
중심으로 브라우저에서 검수했습니다.
...
반복되는 상품 정보와 상태가 화면마다 다른 방식으로 표현되지 않도록,
각 화면이 공통된 사용 흐름과 시각 기준에 맞게 작동하는지 검수했습니다.
...
320px 너비까지 확인하며
텍스트, 버튼, 상품 카드, 상세 화면과 장바구니 UI가
화면 밖으로 벗어나지 않는지 검수했습니다.
